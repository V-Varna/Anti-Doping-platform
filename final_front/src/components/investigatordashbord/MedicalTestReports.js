...
// const App = ({athleteId, otherAthleteId}) => {
//   const [currentAthleteTests, setCurrentAthleteTests] = useState([]);
//   const [otherAthleteTests, setOtherAthleteTests] = useState([]);

//   // Fetch data for both athletes
//   const getData = async () => {
//     try {
//       // Fetch current athlete data
//       const currentResponse = await axios.post("http://localhost:8080/athletes/get-athlete-details-by-id", { athleteId });
//       setCurrentAthleteTests(currentResponse?.data?.MedicalTestReports);

//       // Fetch other athlete data
//       const otherResponse = await axios.post("http://localhost:8080/athletes/get-athlete-details-by-id", { athleteId: otherAthleteId });
//       setOtherAthleteTests(otherResponse?.data?.MedicalTestReports);
//     } catch (error) {
//       console.log(error);
//     }
//   };
...
//   // Prepare test results for bar charts (both athletes)
//   const prepareTestResults = (tests) => {
...
//   const currentAthleteTestResults = prepareTestResults(currentAthleteTests);
//   const otherAthleteTestResults = prepareTestResults(otherAthleteTests);

//   return (
//     <div style={styles.container}>
//       <h1 style={styles.header}>Athlete Medical Test Report Comparison</h1>

//       <div style={styles.visualizationsContainer}>
//         {/* Visualization: Current Athlete's Test Results */}
//         <div style={styles.chartContainer}>
//           <h2>Current Athlete Test Result Bar Chart</h2>
//           <ResponsiveContainer width="100%" height={300}>
//             <BarChart data={currentAthleteTestResults}>
//               <CartesianGrid strokeDasharray="3 3" />
//               <XAxis dataKey="name" />
//               <YAxis />
//               <Tooltip />
...
//         {/* Visualization: Other Athlete's Test Results */}
//         <div style={styles.chartContainer}>
//           <h2>Other Athlete Test Result Bar Chart</h2>
//           <ResponsiveContainer width="100%" height={300}>
//             <BarChart data={otherAthleteTestResults}>
//               <CartesianGrid strokeDasharray="3 3" />
//               <XAxis dataKey="name" />
//               <YAxis />
//               <Tooltip />
//               <Legend />
//               <Bar dataKey="result" fill="#E5B6AB" />
//             </BarChart>
//           </ResponsiveContainer>
//         </div>
//       </div>

//       {/* Medical Test Cards for Current Athlete */}
//       <div style={styles.cardContainer}>
//         {currentAthleteTests?.map((test, index) => (
//           <div key={index} style={styles.card}>
//             <h2 style={styles.cardTitle}>{test.title}</h2>
//             <table style={styles.table}>
//               <tbody>
