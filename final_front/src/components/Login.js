...
const Login = () => {
  ...
  const LoginUser = async (values) => {
    try {
      ...
      setError("The email or password is incorrect. Please try again."); // Add error message here
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {error && <p style={{ color: "red", marginBottom: "15px" }}>{error}</p>} {/* Show error message */}
        ...
        <div style={{ marginTop: "15px", fontSize: "0.9rem" }}>
          <p style={{ color: "#203c5c" }}>
            ...
            <a href="/signup" style={{ color: "#203c5c", fontWeight: "bold" }}>
              Sign Up
            </a>
          </p>
        </div>
